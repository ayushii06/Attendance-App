...
const { startAttendance,getLectureDatesByCourse, markAttendance, stopAttendance, getCourseAttendance, getStudentAttendanceByCourse, updateAttendanceExpiration,checkSession } = require("../controllers/Attendance");
...
router.post("/checkSession",auth,isStudent,checkSession);
