...
const Take_Attendance = () => {
    ...
    //duration, latitude, longitude, course, year, branch, lecture,token

    // newLecture: credentials.lecture == "true"?
            ...
            {sesionStarted ? <div className="text-center mx-12 my-12">
                ...
                <div className="bg-white w-6/12 px-12 dark:bg-gray-900">
                    <div className="py-8 px-4  ">
                        <h2 className="mb-4 text-3xl font-bold text-gray-900 text-center my-2 pb-4 dark:text-white">Start Attendance</h2>
                        <form onSubmit={(e) => {
                            e.preventDefault();
                            ...
                            <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                <div className="w-full">
                                    <label for="brand" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Enter year</label>
                                    <select onChange={handleChange} value={credentials.year} name="year"
                                        id="year" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                ...
                                <div className="w-full">
                                    <label for="brand" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select Branches</label>
                                    <select onChange={handleChange}
                                        value={credentials.branch} name="branch"
                                        id="branch" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                ...
                                <div className="sm:col-span-2">
                                    <label for="brand" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Please Select The Course</label>
                                    <select
                                        onChange={handleChange} value={credentials.course}
                                        id="brand" name="course" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required="">
                                ...
                                <div className="sm:col-span-2">
                                    <label for="brand" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Enter Duration</label>
                                    <input onChange={handleChange} type="number" value={credentials.duration} name="duration" id="brand" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter duration" required="" />
                                </div>

                                <div className="sm:col-span-2">
                                    <label for="brand" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Are you creating a new lecture or resuming attendance of previous one?</label>
                                    <select onChange={handleChange} value={credentials.lecture} name="lecture"
                                        id="lecture" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
