    ...
    return (
        <>
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4">
                                        <button data-modal-target="default-modal"
                                            ...
                                            data-modal-toggle="default-modal" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                                            View Attendance
                                        </button>
            ...
            <div id="default-modal" tabindex="-1" aria-hidden="true"
                class="fixed top-0 left-0 z-50 p-4 w-full h-full bg-black bg-opacity-80 hidden overflow-y">
                <div class="w-2/3  h-2/3 mx-auto my-32 overflow-x-auto overflow-y-auto">
                    <div class=" bg-black text-white rounded-lg shadow ">
                        ...
                        <div class="p-4 md:p-5 space-y-4">
                            <div className="flex justify-center items-center gap-16">
                                <p class="text-lg font-medium text-gray-700 dark:text-gray-400">You have attended {attended_lec} lectures till {datetoISt(Date.now())}</p>
                            ...
                            <table class=" mx-auto my-44 w-full rounded text-center text-white bg-whit">
                                <thead class="text-lg uppercase " style={{ "background": "rgb(113 113 113)" }}>
                                    <tr>
                                ...
                                <tbody >
                                    {enrolledCourses.map((record) => (
                                        <tr key={record._id} class=" border-gray-500 border-x-2 border-b-2" style={{ "background": "rgb(46 46 46)" }}>

                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900 dark:text-gray-200">{datetoISt(record.date)}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-bold text-gray-900 dark:text-gray-200">{record.mark ? <p className="
                                                    text-green-500
